...
public class UserRepoJdbc implements UserRepo {
  ...
  public List<UserModel> getUsers() {
    ...
    String query =
        "SELECT user_id, full_name, login, is_friends(user_id, ?) AS is_friend FROM user WHERE role != 'ADMIN';";
  ...
  public List<UserModel> getUsersByName(String name) {
    ...
    String query =
        "SELECT user_id, full_name, login, is_friends(user_id, ?) as is_friend FROM user WHERE"
            ...
            + "            OR full_name LIKE ?;";
    return jdbc.query(
        query, this::mapResultSetToUserModel, nowUserId, nameParam, nameParam, nameParam);
  }
